...
@endsection
@php
    $indexRoute = fn() => route('orders.index');
    $statusBadge = [
...
@section('pages')
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <h1 class="card-title text-lg mb-4"><b>Pesanan Saya</b></h1>

            <form method="GET" action="{{ $indexRoute() }}" class="mb-6">
                <div class="flex flex-col lg:flex-row gap-2">
                    <div class="form-control grow">
                        <input type="text" name="search" placeholder="Cari nomor invoice..."
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-10 text-base-content/50">
                                    Belum ada pesanan.
                                    <a href="{{ route('caterings.index') }}" class="link link-primary">Cari katering</a>
                                    untuk memulai.
                                </td>
                            </tr>
                        @endforelse
